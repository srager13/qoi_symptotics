...
%\begin{figure}[ht]
%\centering
%\includegraphics[scale=0.35, clip=true, trim=15mm 65mm 20mm 65mm]{figures/use_cases_examples/tness_vs_num_nodes_5_SS_12_IS_2_W.pdf}
%\caption{Achievable Timeliness for various network sizes are quickly evident and comparisons between topologies are quickly seen. (Here, Sum Similarity = 5.0)}
% \label{fig:use_case_tness_vs_num_nodes}
%    \vspace{-3mm}
%\end{figure}
%
%\begin{figure}[ht]
%\centering
%\includegraphics[scale=0.35, clip=true, trim=15mm 65mm 20mm 65mm]{figures/use_cases_examples/sum_sim_vs_num_nodes_50_T_12_IS_2_W.pdf}
%\caption{Achievable Sum Similarity for Increasing Network Size (T = 50)}
% \label{fig:use_case_sum_sim_vs_num_nodes}
%    \vspace{-4mm}
%\end{figure}
