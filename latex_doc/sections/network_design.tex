...
\begin{figure*}
\centering
    \subfigure[Max T vs. Network Size (SS = 5.0)]{
	\includegraphics[scale=0.23, clip=true, trim=14mm 65mm 20mm 65mm]{figures/use_cases_examples/tness_vs_num_nodes_5_SS_12_IS_2_W.pdf}
        \label{fig:use_case_tness_vs_num_nodes}
        }
    \subfigure[Max SS vs. Network Size (T = 50)]{
